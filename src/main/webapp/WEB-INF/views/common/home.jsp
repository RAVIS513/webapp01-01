...
<div id="noteHomeWrapper">
	<div id="noteHomeTitle">
		本サイトについて
	</div>
	<div id="noteHomeContent">
		<p>しがないエンジニアの備忘録です。。。</p><br>
		...
		あらかじめご承知くださいますようお願い致します。</p><br>
		<p>また、サイトに記載されている会社名・製品名・システム名などは、各社の商標、または登録商標です。</p>
	</div>
	<div id="noteHomeFooter">
		<p>Copyright &copy; 2016 TeamRavi. All Rights Reserved.</p>
	</div>
</div>
